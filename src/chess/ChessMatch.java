...
public class ChessMatch  {
	...
	private ChessPiece enPassantVulnurable;
	...
	public ChessPiece getEnPassantVulnurable() {
		return enPassantVulnurable;
	}
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		//#MovimentoEspecial EnPassant
		if(movedPiece instanceof Pawn && (target.getRow() == source.getRow() - 2 || target.getRow() == source.getRow() +2)) {;
		 	enPassantVulnurable = movedPiece;
		}
		 else {
			 enPassantVulnurable = null;
		 }
	...
	private void undoMove(Position source, Position target, Piece capturedPiece) {
		...
		// #Movimento Especial EnPassant
		if(p instanceof Pawn) {
			if(source.getColumn() != target.getColumn() && capturedPiece == enPassantVulnurable) {
